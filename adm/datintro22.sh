...
COURSE_CODE="DD1301.?HT[2-9][0-9] DD1337.?HT[2-9][0-1]"
COURSE_CODE_ORG="${COURSE_CODE_ORG} DD1301.?HT20:datintro20"
COURSE_CODE_ORG="${COURSE_CODE_ORG} DD1337.?HT20:dd1337-ht20-intro"
COURSE_CODE_ORG="${COURSE_CODE_ORG} DD1301.?HT21:datintro21"
COURSE_CODE_ORG="${COURSE_CODE_ORG} DD1337.?HT21:dd1337-ht21-intro"
COURSE_CODE_ORG="${COURSE_CODE_ORG} DD1301.?HT22:datintro22"

export COURSE_CODE COURSE_CODE_ORG

courses="DD1301.?HT2[0-9]"
components="LAB1"
